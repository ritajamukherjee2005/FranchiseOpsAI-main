    ...
    <div className="space-y-6">
      ...
      <div>
        <h2 className="text-xl font-bold text-slate-900 dark:text-slate-100 flex items-center gap-2">
          <FileText className="w-5 h-5 text-indigo-600 dark:text-indigo-400" /> Executive Marketing Report Suite & Export Engine
        </h2>
        <p className="text-xs text-slate-600 dark:text-slate-400">Generate board-ready executive summaries, campaign ROI audits, and financial attribution breakdowns.</p>
      </div>

      {/* Main Container */}
      <div className="glass-card bg-white dark:bg-transparent rounded-xl p-6 border border-slate-200 dark:border-slate-700/60 space-y-6 shadow-md dark:shadow-none">
        {/* Step 1: Select Report Type */}
        <div className="space-y-3">
          <h3 className="text-xs font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider">1. Select Audit Report Type</h3>
            ...
            {[
              ...
              <button
                ...
                className={`p-3.5 rounded-xl text-xs font-semibold text-left border transition-all ${
                  reportType === type
                    ? 'bg-indigo-50 dark:bg-indigo-600/20 border-indigo-500 text-indigo-700 dark:text-indigo-200 shadow-lg shadow-indigo-600/10'
              ...
              >
                <FileText className="w-4 h-4 mb-2 text-indigo-600 dark:text-indigo-400" />
                {type}
              </button>
            ))}
          </div>
        ...
        <div className="space-y-3 pt-4 border-t border-slate-200 dark:border-slate-800">
          <h3 className="text-xs font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider">2. Choose Export Format</h3>
